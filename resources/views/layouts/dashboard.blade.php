...
<head>
    ...
    <link href="{{ asset('dashboard/vendor/fullcalendar/css/fullcalendar.min.css') }}" rel="stylesheet" />
</head>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('dashboard.home.index') }}">Dashboard</a></li>
                            <li><a href="{{ route('dashboard.kalender.index') }}">Kalender</a></li>
                        </ul>
                    </li>
                    <li class="nav-label">Manajemen Profil</li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-app-store"></i><span class="nav-text">Pengaturan Profil</span></a>
                        <ul aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-app-store"></i><span class="nav-text">Konten & Event</span></a>
                        <ul aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-app-store"></i><span class="nav-text">Pengaturan Toko</span></a>
                        <ul aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-app-store"></i><span class="nav-text">Pengaturan Anggota</span></a>
                        <ul aria-expanded="false">
        ...
        <div class="footer">
            <div class="copyright">
                <p>
                    ...
                    <a href="https://www.instagram.com/lagingodingdotcom/" target="_blank"><strong
                            style="color: #008581">LagiNgoding</strong></a> 2024
                </p>
            </div>
        </div>
        <!--**********************************
